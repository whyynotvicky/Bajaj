...
export default function Level3TeamPage() {
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="bg-gradient-to-br from-blue-400 via-blue-500 to-blue-600 rounded-b-3xl pb-8">
        <div className="flex items-center p-4 pt-12">
          ...
          <h1 className="text-white text-2xl font-bold">Level 3 Team</h1>
        </div>
      </div>
      ...
      <div className="px-4">
        {teamMembers.length === 0 ? (
          ...
          <div className="flex items-center mt-8">
            ...
            <p className="text-gray-700 text-lg">No! You have 0 level 3 team members..</p>
          </div>
        ) : (
          // Team Members List
